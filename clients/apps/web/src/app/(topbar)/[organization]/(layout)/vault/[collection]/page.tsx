...
export default async function Page({
  ...
  params: { organization: string; collection: string }
  ...
  const collection = vaultCollectionMocks.find(
    (collection) => collection.slug === params.collection,
  )

  if (organization === undefined || collection === undefined) {
    return <PageNotFound />
  }

  return <ClientPage organization={organization} collection={collection} />
}
